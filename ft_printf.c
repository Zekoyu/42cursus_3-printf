...
/*   Updated: 2021/10/22 18:09:12 by mframbou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	print_arg(char *str, va_list *args, t_conversions *conversions_list)
{
	int	i;
	int	total;
	...
	while (conversions_list[i].type != 0)
	{
		...
		{
			total = conversions_list[i].print_data(args);
			break ;
		}
		i++;
	}
...
//		if (*str == '%')
//		{
//			printed_chars = print_arg((char *) str, args, conversions_list);
//			if (printed_chars != 0)
//			{
//				str += 2;
//				total += printed_chars;
...
int	ft_printf(const char *str, ...)
{
	...
	total = parse_print_string((char *)str, &args, conversions_list);
